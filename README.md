...
<h2>Exceptional</h2>
<p>To avoid code repeat and obey the OOP standards the exceptional class implements cross inheritances common parts of both singleplayer and multiplayer side.</p>
